...
class Example:
    def __init__(self):
        ...
        self.but4 = Button(self.info1, text=4, command=self.summa4, width=10, height=5, bg='green')
        self.but5 = Button(self.info1, text=5, command=self.summa5, width=10, height=5, bg='lime')
        ...
        self.but9 = Button(self.info2, text=4, command=self.summa9, width=10, height=5, bg='green')
        self.but10 = Button(self.info2, text=5, command=self.summa10, width=10, height=5, bg='lime')
        ...
        self.but14 = Button(self.info3, text=4, command=self.summa14, width=10, height=5, bg='green')
        self.but15 = Button(self.info3, text=5, command=self.summa15, width=10, height=5, bg='lime')
        ...
        self.but19 = Button(self.info4, text=4, command=self.summa19, width=10, height=5, bg='green')
        self.but20 = Button(self.info4, text=5, command=self.summa20, width=10, height=5, bg='lime')
        ...
        self.but24 = Button(self.info5, text=4, command=self.summa24, width=10, height=5, bg='green')
        self.but25 = Button(self.info5, text=5, command=self.summa25, width=10, height=5, bg='lime')
        ...
        self.but29 = Button(self.info6, text=4, command=self.summa29, width=10, height=5, bg='green')
        self.but30 = Button(self.info6, text=5, command=self.summa30, width=10, height=5, bg='lime')
        ...
        self.but34 = Button(self.info7, text=4, command=self.summa34, width=10, height=5, bg='green')
        self.but35 = Button(self.info7, text=5, command=self.summa35, width=10, height=5, bg='lime')
