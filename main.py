...
class Example:
    ...
    def open_info(self, num):
        if num == 1:
            info1 = Tk()
            info1.geometry('425x100')
            info1.title('Venus de Milo')
            but1 = Button(info1, text=1, command=self.summa1, width=10, height=5, bg='red')
            but2 = Button(info1, text=2, command=self.summa2, width=10, height=5, bg='orange')
            but3 = Button(info1, text=3, command=self.summa3, width=10, height=5, bg='yellow')
            but4 = Button(info1, text=4, command=self.summa4, width=10, height=5, bg='lime')
            but5 = Button(info1, text=5, command=self.summa5, width=10, height=5, bg='green')
            but1.grid(row=1, column=0)
            but2.grid(row=1, column=1)
            but3.grid(row=1, column=2)
            but4.grid(row=1, column=3)
            but5.grid(row=1, column=4)
            label1 = Label(info1, text='Выберите оценку:')
        ...
        if num == 2:
            ...
            label2 = Label(info, text='Выберите оценку:')
